    ...
    <>
      <form onSubmit={save} className="workspace-card stack">
        ...
        <div className="form-grid">
          ...
          {(
            ["hourlyRate", "baseValue", "discount", "validityDays"] as const
          ).map((key, i) => (
            <label key={key}>
              {
                [
        ...
        <p className="muted">
          ...
          permanecem editáveis na proposta. O relatório inicia incluído no
          pacote (R$ 0), uma adaptação editável, pois a planilha não separa o
          preço por fase.
        </p>
        ...
        <button
          ...
          disabled={
            busy || model.services.filter((s) => s.initial).length !== 3
          }
        >
